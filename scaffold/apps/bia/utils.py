    ...
    for component in context.components:
        ...
        components_writer.writerow(
            [
                ...
                stringify(component.dependencies_equipment),
                stringify(component.dependencies_suppliers),
                stringify(component.dependencies_people),
                stringify(component.dependencies_facilities),
                stringify(component.dependencies_others),
                stringify(auth_slug),
        ...
        if component_csv:
            for row in csv.DictReader(io.StringIO(component_csv)):
                ...
                component = Component(
                    ...
                    dependencies_it_systems_applications=row.get("Dependencies: IT Systems") or None,
                    dependencies_equipment=row.get("Dependencies: Equipment") or None,
                    dependencies_suppliers=row.get("Dependencies: Suppliers") or None,
                    dependencies_people=row.get("Dependencies: People") or None,
                    dependencies_facilities=row.get("Dependencies: Facilities") or None,
                    dependencies_others=row.get("Dependencies: Others") or row.get("Process Dependencies") or None,
