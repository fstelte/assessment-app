...
- [x] Task 3: Tests (2 new tests; export tests pass with a temporary login fixture, PDF/A4 layout checked manually; full pytest evidence blocked by the existing test-login issue)
