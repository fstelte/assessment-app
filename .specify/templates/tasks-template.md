...
> **NOTE: Write the relevant tests FIRST and ensure they fail before implementation when behavior changes are in scope**
...
- [ ] T017 [US1] Add or update audit/logging coverage for user story 1 operations
- [ ] T018 [US1] Update translations, docs, or operator guidance required by user story 1
...
- [ ] T025 [US2] Update translations, docs, or operator guidance required by user story 2
...
- [ ] T031 [US3] Update translations, docs, or operator guidance required by user story 3
...
- [ ] TXXX Migration/backfill validation and release notes updates
...
- Tests for behavior, security, data, or schema changes MUST be written or updated before implementation completes
